  ...
  <div class="form-content container">
      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="form-header">
          ...
          <div class="form-number">
            ...
            <input type="text" id="numero" v-model="formDataSecurity.numero" readonly />
          </div>
          ...
          <div class="form-description">
            ...
            <textarea
              id="description"
              v-model="formDataSecurity.description"
              rows="4"
            ...
            <div class="bloc-left">
              ...
              <div class="date">
                <div>
                  ...
                  <input type="date" id="date" v-model="formDataSecurity.date" />
                </div>
                <div>
                  <label class="bold" for="time">Heure :</label>
                  <input type="time" id="time" v-model="formDataSecurity.time" />
                </div>
              </div>
              <!-- Combien -->
              <div class="space">
                <label class="combien bold" for="combien">Combien ? :</label>
                <input type="text" id="combien" v-model="formDataSecurity.combien" />
              </div>
              <!-- Nom de la personne qui rapporte le problème -->
              <div class="space">
                <label class="bold" for="name">Nom :</label>
                <input type="text" id="name" v-model="formDataSecurity.name" />
              </div>
              <!-- Lieu de l'incident -->
              <div class="space">
                <label class="bold" for="location">Où :</label>
                <input type="text" id="location" v-model="formDataSecurity.location" />
              </div>
            </div>
            ...
            <div class="alert-contacts bloc-center">
              ...
              <div v-for="contact in contacts" :key="contact.id">
                <input
                  ...
                  :value="contact.email"
                  v-model="formDataSecurity.alertContacts"
                />
              ...
              <div class="similar-issue">
                ...
                <div>
                  <input
                    ...
                    id="similarYes"
                    value="yes"
                    v-model="formDataSecurity.similarIssues[0]"
                  />
                ...
                <p v-if="formDataSecurity.similarIssues[0] === 'yes'">
                  Numéro de l'élément sélectionné : {{ formDataSecurity.similarIssues[1] }}
                </p>
              </div>
              ...
              <div class="securisation">
                ...
                <div>
                  <input
                    ...
                    id="securisationYes"
                    value="yes"
                    v-model="formDataSecurity.securisation"
        ...
        <div class="immediate-actions">
          ...
          <div
            v-for="(action, index) in formDataSecurity.immediateActions"
            :key="index"
            class="action-item"
          >
    ...
    <div class="history">
      ...
      <ul>
        ...
        <li
          v-for="(entry, index) in last7DaysDataSecurity"
          :key="index"
